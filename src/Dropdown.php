...
class Dropdown extends Widget
{
    ...
    {
        parent::init();
        Html::addCssClass($this->options, isset($this->options['class']) ? $this->options['class'] : ['widget' => 'dropdown-menu']);
    }
    ...
    protected function renderItems($items, $options = [])
    {
        ...
        foreach ($items as $item) {
            ...
            Html::addCssClass($linkOptions,  isset($linkOptions['class']) ? $linkOptions['class'] : 'dropdown-item');
            if ($disabled) {
