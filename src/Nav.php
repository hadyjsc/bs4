...
class Nav extends Widget
{
    ...
    public function renderItem($item)
    {
        ...
        if (empty($items)) {
            ...
            $linkOptions['data-toggle'] = isset( $linkOptions['data-toggle']) ? $linkOptions['data-toggle'] : 'dropdown';
            Html::addCssClass($options,  isset($options['class']) ? $options['class'] : ['widget' => 'dropdown']);
            Html::addCssClass($linkOptions, isset($linkOptions['class']) ? $linkOptions['class'] : ['widget' => 'dropdown-toggle']);
            if (is_array($items)) {
